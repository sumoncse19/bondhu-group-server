...
const userSchema = new Schema<IUser>(
  {
    ...
    is_club_member: { type: Boolean, default: false },
    club_joining_date: { type: String, default: '' },
    last_one_lac_matching_date: { type: String, default: '' },
    total_club_member: { type: Number, default: 0 },
